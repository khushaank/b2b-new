...
var h = class {
    ...
    onWheel = (t) => {
      ...
      ((e *= l(s, this.window.width)),
        (i *= l(s, this.window.height)),
  ...
  Lenis = class {
    ...
    constructor({
      ...
      ((window.lenisVersion = t),
        window.lenis || (window.lenis = {}),
        (window.lenis.version = t),
        "horizontal" === v && (window.lenis.horizontal = !0),
        (e && e !== document.documentElement) || (e = window),
        "number" == typeof p && "function" != typeof d
          ? (d = a)
          : "function" == typeof d && "number" != typeof p && (p = 1),
        (this.options = {
          wrapper: e,
          content: i,
          eventsTarget: o,
        ...
        (this.dimensions = new s(e, i, { autoResize: f })),
    ...
    scrollTo(
      ...
      if ("number" == typeof m) {
        if (((m += v), (m = Math.round(m)), this.options.infinite)) {
          if (n) {
            this.targetScroll = this.animatedScroll = this.scroll;
            const t = m - this.animatedScroll;
            t > this.limit / 2
              ? (m -= this.limit)
              : t < -this.limit / 2 && (m += this.limit);
          }
        } else m = e(0, m, this.limit);
        if (m === this.targetScroll) return (c?.(this), void p?.(this));
    ...
    hasNestedScroll(t, { deltaX: e, deltaY: i }) {
      ...
      t._lenis || (t._lenis = {});
      const o = t._lenis;
      let n, r, l, h, a, c, p, d, u, m;
      if (s - (o.time ?? 0) > 2e3) {
        o.time = Date.now();
        const e = window.getComputedStyle(t);
        if (
          ((o.computedStyle = e),
          (n = ["auto", "overlay", "scroll"].includes(e.overflowX)),
          (r = ["auto", "overlay", "scroll"].includes(e.overflowY)),
        ...
        ((p = t.scrollWidth),
          ...
          (o.clientWidth = u),
          (o.clientHeight = m),
          (o.hasOverscrollBehaviorX = a),
          (o.hasOverscrollBehaviorY = c));
      } else
        ((l = o.isScrollableX),
          (h = o.isScrollableY),
          (n = o.hasOverflowX),
          ...
          (u = o.clientWidth),
          (m = o.clientHeight),
          (a = o.hasOverscrollBehaviorX),
          (c = o.hasOverscrollBehaviorY));
      if (!((n && l) || (r && h))) return !1;
      const v = Math.abs(e) >= Math.abs(i) ? "horizontal" : "vertical";
      let g, w, S, f, y, E;
      if ("horizontal" === v)
        ((g = Math.round(t.scrollLeft)),
          (w = p - u),
          (S = e),
          (f = n),
          (y = l),
        ...
        if ("vertical" !== v) return !1;
        ((g = Math.round(t.scrollTop)),
          (w = d - m),
          (S = i),
          (f = r),
          (y = h),
      ...
      if (!E && (g >= w || g <= 0)) return !0;
      return (S > 0 ? g < w : g > 0) && f && y;
    }
    get rootElement() {
